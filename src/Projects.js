    ...
    <div className="panel panel-default limitWidth homeBox">
      <div className="panel-body flex-Outer">
        ...
        <p>
          ...
          single page application for administration users to access multiple tables. The page displayed necessary information cleanly, and allowed administrative users to edit, add, or delete information seamlessly.
        </p>
